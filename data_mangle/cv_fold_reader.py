...
class CVFoldReader(object):
    def __init__(self, data_path, folds, seed=None):
        """
        Read data generated by dota_data_crawler_pickle.py or similar files and then split data into K folds.
        """
    ...
    def read_train_test_fold(self, i):
        ...
        :return: train and test data of that fold. Also return M, which is the number of champions
        in the whole complete dataset.
        """
        ...
        return M_o_train, M_r_C_train, M_b_C_train, M_o_test, M_r_C_test, M_b_C_test, self.M

    def read_train_test_valid_fold(self, i):
        """
        Read i-th fold of splitted train/test/validation data

        :return: train, test and validation data of that fold. Also return M, which is the number of champions
        in the whole complete dataset.
        """
